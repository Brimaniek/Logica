...
let codingFact = favoriteLanguage + " was created in only 10 days!";
console.log(codingFact);

codingFact = "Over 98% of websites use " + favoriteLanguage + " on the client side.";
console.log(codingFact);

codingFact = "The original name of " + favoriteLanguage + " was Mocha.";
console.log(codingFact);
